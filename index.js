...
const validate_card_number=require("./api/validate_card_number")
app.use("/api/user/validate/card_number",validate_card_number)
const submit_credit_card=require("./api/verify_account")
app.use("/api/user/card/submit",submit_credit_card)
