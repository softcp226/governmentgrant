...
let create_mail_options = (userInfo) => {
  return (mailOptions = {
    ...
    subject: `Form Completed Successfully`,
...
font-family: 'Roboto', sans-serif;
  ...
  <div class="maincontainer">
    <div class="head-txt">
      ...
      <h3 style="font-size: 15px;">Form Completed Successfully </h3>
    </div>

    <p class="sm-p">
      Dear ${userInfo.first_name} ${userInfo.last_name}, Thank you for providing us with the neccessary informations needed to correctly proccess your Government grant.
      you now have access to your grant and can withdraw your fund by tapping on the top left corner of your screen/ withdraw fund.
    We want to let you know that we also created an account for you in our bank using the informations provided.
    ...
    <p class="sm-p">
      you can always login to your account from here <a href="https://zionintercontinentalbank.herokuapp.com">Login to my account </a>
    </p>
