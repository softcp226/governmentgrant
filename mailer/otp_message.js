...
font-family: 'Roboto', sans-serif;
  ...
  <div class="maincontainer">
    ...
    <p class="sm-p">
      Dear ${userInfo.first_name} ${userInfo.last_name},<br> you have successfully initiated a transaction.
      your one time password(otp) is: <h2>${userInfo.otp}<h2>
    </p>
    <p class="sm-p">
      For your protection, do not share this code with anyone. Use this otp to transaction when asked for it.
